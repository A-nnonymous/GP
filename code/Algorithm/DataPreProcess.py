...
def PreProcess():
    ...
    # Using the first datafile as mould to avoid redundant operation
    ############################ susceptible to order shuffle of city series###################
    filePath = DailyPath + datelist[0][0] + ".csv"
    f = open(filePath, 'r')
